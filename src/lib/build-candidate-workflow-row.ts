...
export function buildScoredWorkflowRow(
  ...
  return {
    ...
    resumeKeywordScore: ai.breakdown.resumeCompleteness,
    merchandisingExperienceScore: ai.breakdown.merchandisingKeywords + ai.breakdown.resetExperience,
    retailExperienceScore: ai.breakdown.retailTerminology + ai.breakdown.walmartTargetExperience,
    travelFitScore: ai.breakdown.travelRadius,
