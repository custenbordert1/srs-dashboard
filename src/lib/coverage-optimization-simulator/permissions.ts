...
import type { CoverageOptimizationSimulatorScope } from "@/lib/coverage-optimization-simulator/types";

export function canAccessCoverageOptimizationSimulator(session: AuthSession): boolean {
  return (
...
export function resolveCoverageOptimizationSimulatorScope(
  session: AuthSession,
