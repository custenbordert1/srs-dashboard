...
export const NAV_GROUPS: NavGroup[] = [
  {
    id: "executive",
    label: "Executive",
    primaryTabs: ["executive-alerts", "daily-action-plan", "recommendation-intelligence", "autopilot-recommendations", "predictive-territory-risk", "executive-operations-center", "executive-summary", "ai-command-center"],
