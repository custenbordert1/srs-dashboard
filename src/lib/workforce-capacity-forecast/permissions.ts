...
import type { WorkforceCapacityForecastScope } from "@/lib/workforce-capacity-forecast/types";

export function canAccessWorkforceCapacityForecast(session: AuthSession): boolean {
  return (
...
export function resolveWorkforceCapacityForecastScope(
  session: AuthSession,
